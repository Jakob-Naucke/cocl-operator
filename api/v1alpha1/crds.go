...
// +kubebuilder:rbac:groups=confidential-clusters.io,resources=approvedimages,verbs=list;watch;patch
// +kubebuilder:rbac:groups=confidential-clusters.io,resources=approvedimages/status,verbs=patch
