...
// kopium command: kopium machineconfigpools.machineconfiguration.openshift.io -A
// kopium version: 0.22.0
...
pub struct MachineConfigPoolConfiguration {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub source: Option<Vec<ObjectReference>>,
    /// UID of the referent.
...
pub struct MachineConfigPoolStatus {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "unavailableMachineCount"
    )]
